...
class Command(BaseCommand):
    ...
    def _create_topics(self):
        ...
        #resources
        uiuc_math_531_fa2015 = Resource.objects.create(name = "Analytical Number Theory Math 531 UIUC", type = "Notes and Problem Sets", url = "http://www.math.illinois.edu/~berndt/math531.html",provider=uiuc)
        cera_crypt = Resource.objects.create(name = "Cryptography I: Stanford University", type = "Full Course", url = "https://www.coursera.org/learn/crypto",provider=coursera)
        ytbst = Resource.objects.create(name = "Data Structures: Binary Search Trees", type = "Online Video", url = "https://www.youtube.com/watch?v=pYT9F8_LFTM",provider=mycodeschool)
        ytrieman = Resource.objects.create(name = "The Riemann Hypothesis", type = "Lecture Video", url = "https://www.youtube.com/watch?v=yhtcJPI6AtY",provider=yale)
        ...
        stanGraph = Resource.objects.create(name="Basic Graph Algorithms", type="PDF", url="https://web.stanford.edu/class/cs97si/06-basic-graph-algorithms.pdf", provider=stanford)
